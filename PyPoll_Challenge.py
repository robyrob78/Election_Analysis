...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (votes > largest_county_turnout_votes) and (county_vote_percentage > largest_county_turnout_votes):
             largest_county_turnout_votes = votes
             largest_county_turnout = county_name
             largest_county_turnout_votes = county_vote_percentage
